...
int XXp1(char *arg)
{
  ...
  printf("XXp1(): receiving message to mailbox %d should block\n", mbox_id);
  result = MboxReceive(mbox_id, buffer, 12);
...
int XXp2(char *arg)
{
  ...
  printf("XXp2(): receiving message from mailbox %d should block\n", mbox_id);
  result = MboxReceive(mbox_id, buffer, 12);
...
int XXp3(char *arg)
{
  ...
  printf("XXp3(): receiving message from mailbox %d, should block\n", mbox_id);
  result = MboxReceive(mbox_id, buffer, 12);
...
int XXp4(char *arg)
{
  ...
  printf("XXp4(): Releasing Mailbox %d\n", mbox_id);
  result = MboxRelease(mbox_id);
  printf("XXp4(): after release of mailbox, result = %d\n", result);
